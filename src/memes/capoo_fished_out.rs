...
// 主要的表情包生成函数
fn capoo_fished_out(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..21 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("capoo_fished_out/{i}.png"))?;
