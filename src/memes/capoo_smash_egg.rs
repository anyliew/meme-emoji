...
// 主要的表情包生成函数
fn capoo_smash_egg(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..4 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("capoo_smash_egg/{i}.png"))?;
