...
// 主要的表情包生成函数
fn capoo_take_smash(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..21 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("capoo_take_smash/{i}.png"))?;
