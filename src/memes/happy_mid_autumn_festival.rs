...
// 主要的表情包生成函数
fn happy_mid_autumn_festival(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..8 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("happy_mid_autumn_festival/{i}.png"))?;
...
// 注册表情包插件
register_meme! {
    "happy_mid_autumn_festival",           // 表情包标识符
