...
// 主要的表情包生成函数
fn happy_national_day(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..5 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("happy_national_day/{i}.png"))?;
