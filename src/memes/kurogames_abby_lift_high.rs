...
// 主要的表情包生成函数
fn kurogames_abby_lift_high(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..8 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("kurogames_abby_lift_high/{i}.png"))?;
...
// 注册表情包插件
register_meme! {
    "kurogames_abby_lift_high",           // 表情包标识符
