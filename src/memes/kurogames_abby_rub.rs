...
// 主要的表情包生成函数
fn kurogames_abby_rub(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..25 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("kurogames_abby_rub/{i}.png"))?;
