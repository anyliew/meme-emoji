...
// 主要的表情包生成函数
fn kurogames_jinhsi_eat(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..9 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("kurogames_jinhsi_eat/{i}.png"))?;
