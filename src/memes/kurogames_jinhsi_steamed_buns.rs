...
// 主要的表情包生成函数
fn kurogames_jinhsi_steamed_buns(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..21 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("kurogames_jinhsi_steamed_buns/{i}.png"))?;
...
// 注册表情包插件
register_meme! {
    "kurogames_jinhsi_steamed_buns",           // 表情包标识符
