...
// 主要的表情包生成函数
fn kurogames_lupa_eat(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..3 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("kurogames_lupa_eat/{i}.png"))?;
