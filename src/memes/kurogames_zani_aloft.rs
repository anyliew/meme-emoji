...
// 主要的表情包生成函数
fn kurogames_zani_aloft(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..14 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("kurogames_zani_aloft/{i}.png"))?;
