...
fn mihoyo_paimon_emergency_food_frame(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    let frame = load_image("mihoyo_paimon_emergency_food_frame/0.png")?;
