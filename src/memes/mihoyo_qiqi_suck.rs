...
// 主要的表情包生成函数
fn mihoyo_qiqi_suck(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..69 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("mihoyo_qiqi_suck/{i}.png"))?;
