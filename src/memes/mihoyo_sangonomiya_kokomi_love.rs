...
// 主要的表情包生成函数
fn mihoyo_sangonomiya_kokomi_love(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..30 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("mihoyo_sangonomiya_kokomi_love/{i}.png"))?;
...
// 注册表情包插件
register_meme! {
    "mihoyo_sangonomiya_kokomi_love",           // 表情包标识符
