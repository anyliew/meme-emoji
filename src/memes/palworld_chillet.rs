...
// 主要的表情包生成函数
fn palworld_chillet(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..25 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("palworld_chillet/{i}.png"))?;
