...
// 主要的表情包生成函数
fn palworld_chillet_god_wealth(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..11 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("palworld_chillet_god_wealth/{i}.png"))?;
...
// 注册表情包插件
register_meme! {
    "palworld_chillet_god_wealth",           // 表情包标识符
