...
// 主要的表情包生成函数
fn read_love_letters(images: Vec<InputImage>, _: Vec<String>, _: NoOptions) -> Result<Vec<u8>, Error> {
    ...
    for i in 0..6 {
        ...
        // 加载预定义的咖波贴图帧
        let frame = load_image(format!("read_love_letters/{i}.png"))?;
